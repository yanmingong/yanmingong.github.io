...
title: "Yanmin Gong"
layout: teaching
excerpt: "NSF CAREER — Ubiquitous & Time-Critical Federated Learning via Cooperative Mobile Edge Networking (CNS-2047761)"
sitemap: false
permalink: /career/
---
...
<figure>
  <img src="{{ site.url }}{{ site.baseurl }}/images/pubpic/career.jpg" width="40%" alt="CAREER project concept: cooperative mobile edge networking for federated learning">
  <img src="{{ site.url }}{{ site.baseurl }}/images/pubpic/testbed2.jpg" width="50%" alt="Prototype/testbed for federated edge learning">
</figure>

### People
- **PI:** Yanmin Gong  
- **Students:** Zhidong Gao (PhD, graduated), Zhenxiao Zhang (PhD, graduated), Yu Zhang (PhD, graduated), Rui Hu (PhD, graduated), Xiangxing Guo (PhD), Guohao Yang (Research Assistant)
